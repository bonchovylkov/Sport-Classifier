...
namespace SportClassifier.Web.Infrastructure.Classifier.Bayesian
{
	public interface ICategorizedWordsDataSource : IWordsDataSource
	{
		...
		WordProbability GetWordProbability(string category, string word,int? catId=null);
		...
		void AddMatch(string category, string word,int? catId=null);
		...
		void AddNonMatch(string category, string word,int? catId=null);
	}
}