...
namespace SportClassifier.Web.Infrastructure.Classifier.Stemmers
{


    class LucenePorterStemmer
    {
        private char[] b;
        ...
        */
        ...
        public static List<string> ExecuteSteamming(List<string> args)
        {
            LucenePorterStemmer s = new LucenePorterStemmer();
            List<string> listStemmedWords = new List<string>();
            ...
            for (int i = 0; i < args.Count; i++)
            {
                ...
                sb.Append(s.ToString());
                listStemmedWords.Add(sb.ToString());


            }
            return listStemmedWords;
        }
        ...
        public static void Main()
        {
            List<string> args = new List<string>()
                {
                    "Simple example",
                    "This is catty and doggy they like goals",
                    "Cant do it becouse it's not necessary",
                };

            List<string> listStemmedWords = ExecuteSteamming(args);


            for (int i = 0; i < listStemmedWords.Count; i++)
            {
                Console.WriteLine(listStemmedWords[i]);
            }
